...
----------------------------------------------------*/
function getRowItems(row: { original: Role }) {
  const s = row.original;
  return [
    { type: "label", label: "Actions sur le rôle" },
    {
...
<template>
  <UDashboardPanel id="roles">
    <template #header>
      <UDashboardNavbar title="Rôles">
        <template #leading>
          <UDashboardSidebarCollapse />
        </template>
        <template #right>
          <RolesAddModal @addrole="refresh()" />
        </template>
      </UDashboardNavbar>
    </template>
